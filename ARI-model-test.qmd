...
I took a look around for what the eligibility standards refer to, and it wasn't particularly clear. I have assumptions that it refers to a lack of affordable housing, since this was made for the Qualified Allocation Plan. 

## Map of ARI by Census Tract, removing ARI of 0

As can be seen, the number of census tracts left in the database diminishes significantly. The number of pin10 observations goes from 1,117,715 to 596,243.
