...
|:-----------------------------------------------------------------------------------------------------------------------|:----------------|:-----------------------------------------------------------------------------------|
| [num_leaves](https://lightgbm.readthedocs.io/en/latest/Parameters.html#num_leaves)                                     | 50 - 2500       | Maximum number of leaves in each tree. Main parameter to control model complexity. |
...
| [feature_fraction](https://lightgbm.readthedocs.io/en/latest/Parameters.html#feature_fraction)                         | 0.3 - 0.9       | The random subset of features selected for a tree, as a percentage.                |
...
| [min_data_in_leaf](https://lightgbm.readthedocs.io/en/latest/Parameters.html#min_data_in_leaf)                         | 2 - 200         | The minimum data in a single tree leaf. Important to prevent over-fitting.         |
...
| [min_data_per_group](https://lightgbm.readthedocs.io/en/latest/Parameters.html#min_data_per_group)                     | 10 - 200        | Minimum number of observations per categorical group                               |
...
model as of 2023-02-09.

    #> Warning: Specifying the `id_cols` argument by position was deprecated in tidyr 1.3.0.
    #> ℹ Please explicitly name `id_cols`, like `` id_cols = `Feature Name`:Notes ``.
