...
data <- model_fetch_run_subset(params$run_id, params$run_id_year, analyses_paths, TRUE)
...
card_individual <- shap %>%
  select(meta_pin, meta_nbhd_code, meta_card_num, pred_card_shap_baseline_fmv,
