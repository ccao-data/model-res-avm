...
Next steps
- Think about shaps on neighborhood level
- Descriptive stats about the variable - correlation plots - condense tables into one plot
- SHAP feature value plots are useful and should be added
- two histograms / feature for training and feature for all properties
- All performance stats should be on test set (both, but mostly test set)
- Feels like there is a good amount of variability between runs and SHAPs.
- Would want to pull maps of training data around xxx
- SHAP of feature scaled to median SHAP of the neighborhood
