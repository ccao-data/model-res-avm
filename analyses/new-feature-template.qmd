...
create_leaflet_map(top_10_data_relative, "shap_relative_value", "Relative SHAP Values")
```
...
create_leaflet_map(bottom_10_data_relative, "shap_relative_value", "Relative SHAP Values", order_scheme = "low")
```
