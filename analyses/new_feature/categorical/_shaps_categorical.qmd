...
```{r, _shaps_categorical_shap_count}
...
```{r _shaps_categorical_township_importance, include = FALSE}
...
```{r _shaps_categorical_violin_plots, results='asis', fig.keep='all'}
# Calculate quantiles
...
```{r _shaps_categorical_scatterplot, fig.keep='all'}
shapviz::shapviz(
  object = shap_new %>%
