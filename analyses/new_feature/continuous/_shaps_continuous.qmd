...
```{r _shaps_continuous_full_importance}
...
```{r _shaps_continuous_township_importance, echo=FALSE,warning=FALSE,message=FALSE,error=FALSE, results='asis',fig.keep='all'}
shap_df_filtered_long %>%
...
```{r _shaps_continuous_scatterplot, warning=FALSE,message=FALSE,error=FALSE, results='asis',fig.keep='all'}
shapviz::shapviz(
  object = shap_new %>%
...
```{r _shaps_continuous_violin_plot, results='asis', fig.keep='all'}
