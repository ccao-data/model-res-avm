...
```{r _descriptive_stats_continuous_histogram_function}
...
```{r _descriptive_stats_continuous_feature_histogram}
...
```{r _descriptive_stats_continuous_fmv_change_histogram, results='asis',fig.keep='all'}
create_histogram_with_statistics(
  data = pin_individual,
...
```{r _descriptive_stats_continuous_shap_change_histogram, results='asis',fig.keep='all'}
create_histogram_with_statistics(
  data = shap_new,
  target_feature = target_feature_value,
  x_label = "SHAP Value",
...
```{r _descriptive_stats_continuous_correlation_between_features}
columns_to_remove <- c(
  "Sale Year",
  "Sale Month of Year",
  "Sale Day of Year",
...
```{r _descriptive_stats_continuous_top_10_correlation_plot}
