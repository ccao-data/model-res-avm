...
assessment_pin %>%
  ...
  select(meta_pin, meta_class, meta_cards = meta_pin_num_cards, scales::dollar(pred_pin_final_fmv), township_name, char_total_bldg_sf, char_yrblt) %>%
...
Here we look at the largest misses across all sales in the training data grouped by township. These are sales which may be outliers or have issues in the training data.
