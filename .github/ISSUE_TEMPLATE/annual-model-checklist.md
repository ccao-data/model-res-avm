...
- [ ] Make sure the attached deliverables have been thoroughly reviewed and send the condo model email with the subject line `$YEAR Initial Model Values (Condos)`
