...
Here we look at the largest misses across all sales in the training data grouped by township.
...
Due to a low R2 and high RMSE in the linear model, there were suspected bad sales in Barrington. A closer look finds some sales which are on the high-end, but looking at individual PINs and the estimated FMV does not provide evidence of sales errors.
