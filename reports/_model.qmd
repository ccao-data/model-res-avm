...
reshaped_data <- sales_vs_estimates %>%
  ...
  mutate(
    space_maker = as.numeric(factor(category)),
...
line_ends <- reshaped_data %>%
  ...
  mutate(
    color_class = ifelse(grepl("Sale", category), "Sale", "Estimate"),
