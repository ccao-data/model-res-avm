...
ggplot() +
  geom_segment(data = line_ends, 
               aes(x = Start, 
                   ...
                   y = space_maker, 
                   yend = space_maker,
                   color = ifelse(grepl("Sale", category), 
                                  "SaleColor", "EstimateColor")), 
               size = 1.2) +
  ...
  labs(x = "Value", y = "Category", title = "Sales vs Estimates by Township") +
  scale_color_manual(values = c("SaleColor" = "darkolivegreen",   
                                "EstimateColor" = "darkgoldenrod3")) +
