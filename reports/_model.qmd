...
```{r _overall_ratio_distribution_decile, fig.width=10, fig.height=6}
...
```{r _ratio_distribution_township_decile}
...
```{r _iterate_township_decile_tabset, results='asis'}
...
```{r _feature_importance_function}
...
```{r _gain_score, fig.width=8, fig.height=30, fig.align='center'}
...
```{r _cover_score, fig.width=8, fig.height=30, fig.align='center'}
plot_feature_importance(
  feat_imp_df,
  "cover_value",
  "darkslategray"
...
```{r _frequency_score, fig.width=8, fig.height=30, fig.align='center'}
plot_feature_importance(
  feat_imp_df,
  "frequency_value",
  "chocolate3"
