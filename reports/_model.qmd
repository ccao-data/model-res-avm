...
## Sales Chasing
This chart looks at if there are significant differences in the median increase (dollar and percentage) for houses which are sold and un-sold in the previous year.
...
assessment_pin %>%
  ...
  add_header_above(c("Township" = 1, "Ratio" = 1, "Sold Houses" = 1, "Un-Sold Houses" = 1, "Ratio" = 1, "Sold Houses" = 1, "Un-Sold Houses" = 1)) %>%
  add_header_above(c(" " = 1, "Percentage Change" = 3, "Dollar Change" = 3)) %>%
  add_header_above(c("Comparison of YOY Change in Value for Sold and Un-Sold Houses" = 7))
```
