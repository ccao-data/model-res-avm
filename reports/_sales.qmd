...
Sales by by quarter for the previous 4 years. The goal is to see how different segments of the market are changing as a proportion in each tri-town. Sales are binned into 4 different groups based on price.
...
price_change <- ggplot(
  ...
  labs(
    y = "Median Sale Price",
    x = "Year",
    title = paste("Price / Price of", as.numeric(params$year) - 4, ", Outliers Excluded"),
  ) +
  theme_minimal() +
  theme(
...
map2(tri_sales, names(tri_sales), function(x, title) {
