...
```{r shap_filtering, eval=shap_exists}
...
```{r shap_function, eval=shap_exists}
...
```{r shap_riverside_beeswarm, eval=shap_exists}
...
```{r calumet_beeswarm, eval=shap_exists}
...
```{r thornton_beeswarm, eval=shap_exists}
