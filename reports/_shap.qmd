...
```{r _shap_filtering, eval=shap_exists}
...
```{r _shap_table, eval=shap_exists}
shap_df_filtered %>%
  select(
...
```{r _shap_function, eval=shap_exists}
...
```{r _shap_riverside_header, results='asis', eval=shap_exists}
...
```{r _shap_riverside_footer, results='asis', eval=shap_exists}
cat("## Calumet Beeswarm")
```

```{r _shap_calumet_beeswarm, eval=shap_exists}
...
```{r _shap_thornton_header, results='asis', eval=shap_exists}
...
```{r _shap_thornton_footer, results='asis', eval=shap_exists}
cat(":::")
```
