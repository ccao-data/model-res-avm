...
train_md5 <- if (train_md5_s3 != train_md5_local) {
  train_md5_s3
} else {
  train_md5_local
}
...
# Data path
data_path <-
  "~/model-res-avm-move-existing-reports/data/res_parcels.parquet"

# GATHER DATA ----

sales <-
  arrow::read_parquet("~/ccao_res_avm/input/training_data.parquet")
