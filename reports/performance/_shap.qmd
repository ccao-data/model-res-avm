...
```{r _shap_beeswarm_iterate_township, results='asis', warning=F}
...
```{r}
make_township_beeswarm_graph <- function(township_to_iterate) {

  shap_idx_riverside <- which(
      assessment_card_filtered$meta_township_code == township_to_iterate
    )
...
make_township_beeswarm_graph("33")
```


<!-- ::: {.panel-tabset} -->

<!-- ```{r _shap_beeswarm_iterate_township_test, results='asis'} -->
<!-- # Dynamically produce tabset -->

<!-- for (township in townships_to_iterate) { -->
<!--   cat("##", ccao::town_convert(township), "\n") -->
<!--   make_township_beeswarm_graph(township) -->
<!--   cat("\n\n") -->
<!-- } -->
<!-- ``` -->
