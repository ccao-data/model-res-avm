...
rbind(
  ...
  select(meta_sale_price:meta_tieback_proration_rate,
...
ggplot(
  ...
  labs(
    y = "Median Sale Price", x = "Year", title = "By Year and Outlier Status"
  ) +
  theme_minimal() +
  theme(
    legend.position = "bottom",
...
ggplot(
  ...
  labs(
    y = "Number of Sales", x = "Year", title = "By Year and Outlier Status"
  ) +
  theme_minimal() +
  scale_y_continuous(
    labels = scales::comma,
