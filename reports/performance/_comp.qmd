...
## Neighborhood Level Means for each Property's Comparison Score
Each property has 20 comparable sales. The mean is taken for these scores, before taking the average for the total neighborhood (Mean of a mean).
```{r}
