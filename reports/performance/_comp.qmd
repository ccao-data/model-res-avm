...
# Creating a list of ggplot objects
plots <- list(
  single_family_plot = create_plot(res_single_family, "Single Family"),
  multi_family_plot = create_plot(res_multi_family, "Multi Family"))
