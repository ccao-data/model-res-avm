...
training_data_outlier_analysis <-
  ...
  mutate(
    ...
    str_detect(
      sv_outlier_reason,
      regex("Review: Non-Arms-Length", ignore_case = TRUE)
    ) &
      str_detect(
        sv_outlier_reason,
        regex("Algorithm: Low price", ignore_case = TRUE)
      ) ~
    ...
    str_detect(
      ...
      str_detect(
        sv_outlier_reason,
        regex("Algorithm: High price", ignore_case = TRUE)
      ) ~
    ...
    str_detect(
      sv_outlier_reason,
      regex("Review: Flip", ignore_case = TRUE)
    ) &
      str_detect(
        sv_outlier_reason,
        regex("Algorithm: Low price", ignore_case = TRUE)
