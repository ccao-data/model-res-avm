  ...
  plots <- imap(datasets, ~ {
    p <- ggplot(.x, aes(
      ...
      scale_x_continuous(
        name = "Actual FMV",
        limits = c(0, 2000000),
        labels = dollar_format() # Format x-axis labels as dollars
      ) +
      scale_y_continuous(
        name = "Estimated FMV",
        limits = c(0, 2000000),
        labels = dollar_format() # Format y-axis labels as dollars
      ) +
...
plots <- create_plots(datasets_sold)
```
