...
This report inspects properties that are difficult to assess due to outlier or poorly tracked characteristics. All outputs below are for the entirety of Cook County. The universe of sold data is from prior year sales. Challenge groups are:
...
datasets_minus_missing_location <- datasets_full %>%
