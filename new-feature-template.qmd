...
```{r download new data, echo = FALSE}
analyses_paths <- list(
  output = list(
    list(
...
```{r download comparison data, echo = FALSE}
...
if (!exists("assessment_pin_comparison")) {
...
- The varible is highly correlated with another existing variable.
