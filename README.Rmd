...
We [tried a number of other model types and frameworks](#31), including regularized linear models, [XGBoost](https://xgboost.readthedocs.io/en/latest/), [CatBoost](https://catboost.ai/), random forest, shallow neural networks, and support vector machines. We even tried ensemble methods such as [model stacking](https://github.com/ccao-data/model-res-avm/commit/77de50dce86986f8d442f05c161438933c097958). We chose LightGBM because it has the right mix of trade-offs for our needs. Specifically, LightGBM is:
...
* Separated development/reporting dependencies from primary dependencies using [renv profiles](https://github.com/ccao-data/model-res-avm?tab=readme-ov-file#profiles-and-lockfiles) to increase replicability.
...
We *do* use [comparables for other things](https://www.cookcountyassessor.com/what-are-comparable-properties), namely when processing appeals and when evaluating the model's performance. Note however that the comparables generated via #106 are _experimental_ and are not currently used.
